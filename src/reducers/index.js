export default (
  state = {
    ...
    TubePressureDropFormState: {
      ...
      tubeLength: 15.0,// m
      diameterOptions: [
        { value: 0.00635, label: '1/4 (DN8)' },
        { value: 0.009525, label: '3/8 (DN10)' },
        { value: 0.0127, label: '1/2 (DN15)' },
        { value: 0.01905, label: '3/4 (DN20)' },
        { value: 0.0254, label: '1 (DN25)' },
        { value: 0.03175, label: '1 1/4' },
        { value: 0.0381, label: '1 1/2 (DN40)' },
        //{ value: 0.04445, label: '1 3/4' },
        { value: 0.0508, label: '2 (DN50)' },
        //{ value: 0.05715, label: '2 1/4' },
        { value: 0.0635, label: '2 1/2 (DN80)' },
        //{ value: 0.06985, label: '2 3/4' },
        { value: 0.0762, label: '3 (DN120)' },
        //{ value: 0.08255, label: '3 1/4' },
        { value: 0.0889, label: '3 1/2' },
        //{ value: 0.09525, label: '3 3/4' },
        { value: 0.1016, label: '4 (DN200)' },
        { value: 0.127, label: '5 (DN300)' },
        { value: 0.1524, label: '6 (DN450)' },
        { value: 0.1651, label: '6 1/2' },
        { value: 0.1778, label: '7' },
        { value: 0.2032, label: '8 (DN750)' },
