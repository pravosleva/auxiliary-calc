  ...
  render() {
    ...
    return (
      <div>
        ...
        <input type='number' style={{MozAppearance:'textfield'}} className='form-control' value={workTimeCoefficient} onChange={this.changeTankFormState.bind(this, 'workTimeCoefficient')} />
        <label>Operating mode time Start-Finish, h</label>
        <input type='number' style={{MozAppearance:'textfield'}} className='form-control' value={operatingModeTime} onChange={this.changeTankFormState.bind(this, 'operatingModeTime')} />
        <label className={totalLiquidDuctSystemVolume > 0 ? '' : 'text-danger'}>V liquid duct system, m3</label>
        <input type='number' style={{MozAppearance:'textfield'}} className='form-control' value={totalLiquidDuctSystemVolume} onChange={this.changeTankFormState.bind(this, 'totalLiquidDuctSystemVolume')} />
