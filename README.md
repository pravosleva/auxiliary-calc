...
![about MEG density](./_imgs/density-MEG.PNG)
...
- [x] **7.1 Duct System calc** by tubes Length and Diameter. Internal `LiquidParameters` module updated. This calc could be enabled in **dPw total calc (see below)**.
- [x] **7.2 Total Drop Pressure calc** added
